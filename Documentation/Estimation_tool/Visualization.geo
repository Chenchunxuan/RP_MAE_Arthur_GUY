...
Point(79) = {4.6, - 5.1, -5.7};	Point(80) = {4.6, - 4.1, -5.7};
Point(81) = {-4.6, - 5.1, -5.7};	Point(82) = {-4.6, - 4.1, -5.7};
Point(83) = {4.6,  5.1, -5.7};	Point(84) = {4.6,  4.1, -5.7};
Point(85) = {-4.6,  5.1, -5.7};	Point(86) = {-4.6,  4.1, -5.7};

Circle(273) = {79, 60, 80};	Circle(274) = {80, 60, 79};
Circle(275) = {81, 62, 82};	Circle(276) = {82, 62, 81};
Circle(277) = {83, 59, 84};	Circle(278) = {84, 59, 83};
Circle(279) = {85, 61, 86};	Circle(280) = {86, 61, 85};

Curve Loop(141) = {274, 273};
Plane Surface(141) = {141};
Curve Loop(142) = {275, 276};
Plane Surface(142) = {142};
Curve Loop(143) = {280, 279};
Plane Surface(143) = {143};
Curve Loop(144) = {277, 278};
